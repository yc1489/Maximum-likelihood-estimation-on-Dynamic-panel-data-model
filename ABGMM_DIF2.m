...
Zy_DIF2 = zeros(m_DIF2,1);  ZX_DIF2 = zeros(m_DIF2,K+1);  ZZ_DIF2 = zeros(m_DIF2,m_DIF2);     
...
delta_GMM0(sml,1)  = GMM_DIF2_1step;  % saving gamma in est_gam_nsml
se_GMM0(sml,1)  =abs(sqrt(var_DIF2_1step));   % saving standard error of gamma in se_gam_nsml
