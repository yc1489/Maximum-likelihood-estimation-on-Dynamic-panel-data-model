...
save('ABGMMS_r_1.mat','bias_mean_gam','se_gam','rmse_gam','power1_gamma','power2_gamma','size_gamma','power4_gamma','power5_gamma');
...
save('ABGMMS_r_10.mat','bias_mean_gam','se_gam','rmse_gam','power1_gamma','power2_gamma','size_gamma','power4_gamma','power5_gamma');
clear all;
...
save('ABGMMm_5r_1.mat','bias_mean_gam','se_gam','rmse_gam','power1_gamma','power2_gamma','size_gamma','power4_gamma','power5_gamma');
...
save('ABGMMm_5r_10.mat','bias_mean_gam','se_gam','rmse_gam','power1_gamma','power2_gamma','size_gamma','power4_gamma','power5_gamma');
...
save('ABGMMm_1r_1.mat','bias_mean_gam','se_gam','rmse_gam','power1_gamma','power2_gamma','size_gamma','power4_gamma','power5_gamma');
...
save('ABGMMm_1r_10.mat','bias_mean_gam','se_gam','rmse_gam','power1_gamma','power2_gamma','size_gamma','power4_gamma','power5_gamma');
...
save('ABGMMm_0r_1.mat','bias_mean_gam','se_gam','rmse_gam','power1_gamma','power2_gamma','size_gamma','power4_gamma','power5_gamma');
...
save('ABGMMm_0r_10.mat','bias_mean_gam','se_gam','rmse_gam','power1_gamma','power2_gamma','size_gamma','power4_gamma','power5_gamma');
...
y(:,1)=0;           % setting the initial value of data
for tt=2:TT
   y(:,tt)=gamma*y(:,tt-1)+alpha+u(:,tt);  % gen data
end
Y_NT=y(:,TT-T0:TT)';    
...
save('HABGMMm_5r_1.mat','bias_mean_gam','se_gam','rmse_gam','power1_gamma','power2_gamma','size_gamma','power4_gamma','power5_gamma');
...
save('HABGMMm_5r_10.mat','bias_mean_gam','se_gam','rmse_gam','power1_gamma','power2_gamma','size_gamma','power4_gamma','power5_gamma');
...
save('HABGMMm_1r_1.mat','bias_mean_gam','se_gam','rmse_gam','power1_gamma','power2_gamma','size_gamma','power4_gamma','power5_gamma');
...
save('HABGMMm_1r_10.mat','bias_mean_gam','se_gam','rmse_gam','power1_gamma','power2_gamma','size_gamma','power4_gamma','power5_gamma');
...
save('HABGMMm_0r_1.mat','bias_mean_gam','se_gam','rmse_gam','power1_gamma','power2_gamma','size_gamma','power4_gamma','power5_gamma');
...
save('HABGMMm_0r_10.mat','bias_mean_gam','se_gam','rmse_gam','power1_gamma','power2_gamma','size_gamma','power4_gamma','power5_gamma');
...
alpha=eta*(varu+normrnd(0,1,[N,1]));
y=zeros(N,TT);  % creat a space for saving data
y(:,1)=alpha/(1-gamma)+normrnd(0,1/(1-gamma^2), [N,1]);            % setting the initial value of data
for tt=2:TT
   y(:,tt)=gamma*y(:,tt-1)+alpha+u(:,tt);  % gen data
end
Y_NT=y(:,TT-T0:TT)';    
...
save('HSABGMMr_1.mat','bias_mean_gam','se_gam','rmse_gam','power1_gamma','power2_gamma','size_gamma','power4_gamma','power5_gamma');
...
save('HSABGMMr_10.mat','bias_mean_gam','se_gam','rmse_gam','power1_gamma','power2_gamma','size_gamma','power4_gamma','power5_gamma');
