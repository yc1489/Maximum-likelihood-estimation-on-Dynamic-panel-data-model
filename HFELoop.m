...
Y_NT=y(:,1:end)'; % discard first 50 observation 
...
save('HFEm_0r_0.1.mat','bias_mean_gam','se_gam','rmse_gam','power1_gamma','power2_gamma','size_gamma','power4_gamma','power5_gamma');
...
save('HFEm_0r_10.mat','bias_mean_gam','se_gam','rmse_gam','power1_gamma','power2_gamma','size_gamma','power4_gamma','power5_gamma');
...
Y_NT=y(:,:)'; % discard first 50 observation 
...
save('HFESr_0.1.mat','bias_mean_gam','se_gam','rmse_gam','power1_gamma','power2_gamma','size_gamma','power4_gamma','power5_gamma');
