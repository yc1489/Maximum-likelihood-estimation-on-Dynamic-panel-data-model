...
[theta, fval, exitflag, output, lambda, hessian] = Kruiniger_opt(N,T0,Dy,Dy1,theta0,lq,uq);
...
se_gam_nsml(sml,1)  =abs(sqrt((var_ML/N)));   % saving standard error of gamma in se_gam_nsml
